...
import kotlinx.android.synthetic.main.activity_escrow_buyer.*
...
class EscrowBuyerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_escrow_buyer)
