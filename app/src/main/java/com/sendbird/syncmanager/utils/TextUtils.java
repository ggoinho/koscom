...
public class TextUtils {
    public static String getGroupChannelTitle(GroupChannel channel) {
        ...
        Log.d(TextUtils.class.getSimpleName(), "members : " + members.size());

        StringBuffer namesLog = new StringBuffer();
        for (Member member : members) {
            namesLog.append(", " + member.getUserId());
        }
        Log.d(TextUtils.class.getSimpleName(), "namesLog : " + namesLog.toString());
        ...
        Log.d(TextUtils.class.getSimpleName(), "myUserId : " + myUserId);
