...
public class DateUtils {
    ...
    public static String format2Time(long timeInMillis) {
    ...
    public static String format2Date(long timeInMillis) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy년 MM월 dd일 EE요일", Locale.getDefault());
        return dateFormat.format(timeInMillis);
    }
    public static String format3Date(long timeInMillis) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyyMMdd", Locale.getDefault());
        return dateFormat.format(timeInMillis);
    }
    public static String format4Date(long timeInMillis) {
